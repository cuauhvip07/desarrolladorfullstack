        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog3.jpg" alt="Imagen blog 2" width="500" height="300">
                </picture>
            </div> <!-- .imagen -->
            <div class="texto-entrada">
                <a href="entrada.php">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog4.jpg" alt="Imagen blog 2" width="500" height="300">
                </picture>
            </div> <!-- .imagen -->
            <div class="texto-entrada">
                <a href="entrada.php">
